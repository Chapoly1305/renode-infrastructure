...
{
    public partial class SiLabs_CMU_7 : SiLabs_ICMU
    {
        public SiLabs_CMU_7(Machine machine, SiLabs_IHFXO hfxo, SiLabs_DPLL_1 dpll = null) : base(machine)
        {
            this.dpll = dpll;
            this.hfxo = hfxo;
        ...
        {
            // PERPLL is not present on CMU_7
            return false;
        }

        public bool OscSocpllEnabled(uint instance)
        {
            // SOCPLL is not present on CMU_7
            return false;
        }
        ...
        public bool Eusart2Enabled { get; set; } = true;

        public bool Eusart3Enabled { get; set; } = true;
        ...
        public bool Timer5Enabled { get; set; } = true;

        public bool Timer6Enabled { get; set; } = true;

        public bool Timer7Enabled { get; set; } = true;

        public bool Timer8Enabled { get; set; } = true;

        public bool Timer9Enabled { get; set; } = true;

        public bool Usart0Enabled { get; set; } = true;

        public bool Usart1Enabled { get; set; } = true;

        public bool Usart2Enabled { get; set; } = true;
        ...
        public bool LcdEnabled { get; set; } = true;

        public bool I2c0Enabled { get; set; } = true;

        public bool I2c1Enabled { get; set; } = true;

        public bool I2c2Enabled { get; set; } = true;

        public bool I2c3Enabled { get; set; } = true;
        ...
        public bool OscLfrcoRequested
        {
            get
            {
                return exportclkctrl_clkoutsel0_field.Value == EXPORTCLKCTRL_CLKOUTSEL0.LFRCO
                    ...
                    || (
                        LcdEnabled
                        && clken1_lcd_bit.Value
                        && lcdclkctrl_clksel_field.Value == LCDCLKCTRL_CLKSEL.LFRCO
                    );
            }
        }
            ...
            get
            {
                return exportclkctrl_clkoutsel0_field.Value == EXPORTCLKCTRL_CLKOUTSEL0.LFXO
                    ...
                    || (
                        LcdEnabled
                        && clken1_lcd_bit.Value
                        && lcdclkctrl_clksel_field.Value == LCDCLKCTRL_CLKSEL.LFXO
                    );
            }
        }
        ...
        partial void Calcnt_Calcnt_ValueProvider(ulong a)
        {
            ...
            GetUpselFrequency[CALCTRL_UPSEL.PFMOSC] = 100000000UL;
            GetUpselFrequency[CALCTRL_UPSEL.BIASOSC] = 1000000UL;
            ...
            GetUpselFrequency[CALCTRL_UPSEL.HFRCOSE] = 1000000UL;
            GetUpselFrequency[CALCTRL_UPSEL.TEMPOSC] = 1000000UL;
            ...
            GetDownselFrequency[CALCTRL_DOWNSEL.PFMOSC] = 100000000UL;
            GetDownselFrequency[CALCTRL_DOWNSEL.BIASOSC] = 1000000UL;
            ...
            GetDownselFrequency[CALCTRL_DOWNSEL.HFRCOSE] = 1000000UL;
            GetDownselFrequency[CALCTRL_DOWNSEL.TEMPOSC] = 1000000UL;
        ...
        private bool isEm01GrpaClkEnabled()
        {
            ...
            EM01GRPACLK_LUT[8] = Timer5Enabled && clken2_timer5_bit.Value;
            EM01GRPACLK_LUT[9] = Timer6Enabled && clken2_timer6_bit.Value;
            EM01GRPACLK_LUT[10] = Timer7Enabled && clken2_timer7_bit.Value;
            EM01GRPACLK_LUT[11] = Timer8Enabled && clken2_timer8_bit.Value;
            EM01GRPACLK_LUT[12] = Timer9Enabled && clken2_timer9_bit.Value;
            // missing PD0B
            // missing KEYPAD
        ...
        private bool isEm01GrpcClkEnabled()
        {
            ...
            EM01GRPCCLK_LUT[2] = Eusart2Enabled && clken2_eusart2_bit.Value;
            EM01GRPCCLK_LUT[3] = Eusart3Enabled && clken2_eusart3_bit.Value;
            // missing PD0D
