...
{
    public class SiLabs_SEMAILBOX_1 : SiLabsPeripheral
    {
        public SiLabs_SEMAILBOX_1(Machine machine) : base(machine)
        {
            ...
            secureElement = new SiLabs_SecureElement(machine, this, txFifo, rxFifo, false);
        }
