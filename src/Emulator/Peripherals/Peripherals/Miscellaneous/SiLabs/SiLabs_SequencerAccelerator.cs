...
namespace Antmicro.Renode.Peripherals.Miscellaneous.SiLabs
{
    ...
    {
        public SiLabs_SequencerAccelerator(Machine machine, ulong frequency, SiLabs_IProtocolTimer protocolTimer = null) : base(machine, false)
        {
        ...
        protected class Sequence
        {
            ...
            protected Enumeration_A ExecuteSingleInstruction()
            {
                ...
                case Enumeration_D.EnumerationDValue6:
                {
                    ...
                    uint srcBaseAddress = parent.machine.SystemBus.ReadDoubleWord(currentAddress + 4);
