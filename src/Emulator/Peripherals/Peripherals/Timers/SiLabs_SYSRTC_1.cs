...
{
    public class SiLabs_SYSRTC_1 : SiLabsPeripheral
    {
        public SiLabs_SYSRTC_1(Machine machine, uint frequency) : base(machine)
        {
        ...
        private IEnumRegisterField<CaptureEdgeSelect> group1CaptureEdgeSelect;
        private IEnumRegisterField<CaptureEdgeSelect> group0CaptureEdgeSelect;
        // Interrupts
