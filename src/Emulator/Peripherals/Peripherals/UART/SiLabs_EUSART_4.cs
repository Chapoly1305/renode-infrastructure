...
namespace Antmicro.Renode.Peripherals.UART
{
    ...
    public class SiLabs_EUSART_4 : UARTBase, IUARTWithBufferState, IDoubleWordPeripheral, IPeripheralContainer<ISPIPeripheral, NullRegistrationPoint>, IKnownSize, SiLabs_IRetention
    {
        public SiLabs_EUSART_4(Machine machine, uint clockFrequency = 19000000) : base(machine)
        {
            ...
            ReceiveIRQ = new GPIO();
            RxFifoLevelRequest = new GPIO();
            TxFifoLevelRequest = new GPIO();
            RxFifoLevelGpioSignal = new GPIO();

            deferTimer = new LimitTimer(machine.ClockSource, 1000000, this, "esuart-defer-timer", 1, direction: Direction.Ascending,
        ...
        public override void Reset()
        {
            ...
            RxFifoLevelRequest.Set(false);
            TxFifoLevelRequest.Set(false);
        ...
        public GPIO TxFifoLevelRequest { get; }

        public GPIO RxFifoLevelRequest { get; }
        ...
        {
            byte character;
            bool ret =  TryGetCharacter(out character);
            return ret ? character : (byte)0;
        }
        ...
        private DoubleWordRegisterCollection BuildRegistersCollection()
        {
            var registerDictionary = new Dictionary<long, DoubleWordRegister>
            {
                ...
                {(long)Registers.Cfg_2, new DoubleWordRegister(this, 0x20)
                ...
                {(long)Registers.FrameCfg, new DoubleWordRegister(this, 0x1002)
                ...
                {(long)Registers.IrHfCfg, new DoubleWordRegister(this)
                 ...
                 {(long)Registers.TimingCfg, new DoubleWordRegister(this, 0x50000)
