...
namespace Antmicro.Renode.Peripherals.Wireless
{
    ...
    {
        public SiLabs_xG22_LPW(Machine machine, CortexM sequencer, SiLabs_BUFC_1 bufferController, ulong clockFrequency, SiLabs_RTCC_1 prortc = null)
        {
        ...
        public void ReceiveFrame(byte[] frame, IRadio sender)
        {
            ...
            this.Log(LogBasicRadioActivityAsError ? LogLevel.Error : LogLevel.Info, "ReceiveFrame() at {0} on channel {1} ({2}) ({3}Hz), TX started at {3} (diff: {4})",
        ...
        private void RAC_SeqTimerRestart(ushort startValue, ushort limit)
        {
            ...
            seqTimer.Divider = RAC_seqTimerPrescaler.Value + 1UL;
