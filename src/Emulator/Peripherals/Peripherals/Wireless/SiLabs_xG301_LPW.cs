...
namespace Antmicro.Renode.Peripherals.Wireless
{
    ...
    {
        public SiLabs_xG301_LPW(Machine machine, ulong clockFrequency, CV32E40P sequencer = null, SiLabs_IRvConfig sequencerConfig = null, SiLabs_BUFC_5 bufferController = null, SiLabs_SYSRTC_2 sysrtc = null)
        {
            this.machine = machine;
            this.hfxoFrequency = clockFrequency;
            ...
            if(sysrtc != null)
            {
                sysrtc.CompareMatchGroup1Channel0 += () => PROTIMER_RtcCapture(0);
                sysrtc.CompareMatchGroup1Channel1 += () => PROTIMER_RtcCapture(1);
            }
        ...
        public void Reset()
        {
            ...
            SYNTH_state = Enumeration_AE.EnumerationAEValue0;
        ...
        public void UpdateInterrupts()
        {
            machine.ClockSource.ExecuteInLock(delegate
            {
                ...
                var irq = ((field_311.Value && field_312.Value)
                ...
                irq = ((field_308.Value & field_309.Value) > 0);
                if(LogInterrupts && irq)
                {
                }
                ...
                irq = (field_261.Value && field_262.Value)
                       || (field_235.Value && field_236.Value)
                       || (field_294.Value && field_295.Value)
                       || (field_256.Value && field_257.Value)
                       || (field_244.Value && field_245.Value)
                       || (field_252.Value && field_253.Value)
                       || (field_259.Value && field_260.Value)
                       || (field_269.Value && field_270.Value);
                ...
                irq = ((field_379.Value && field_380.Value)
                ...
                irq = ((field_319.Value && field_320.Value)
                       || (field_357.Value && field_358.Value));
                if(LogInterrupts && irq)
                {
                }
                ...
                irq = (field_286.Value && field_287.Value)
                       || (field_276.Value && field_277.Value)
                       || (field_290.Value && field_291.Value)
                       || (field_282.Value && field_283.Value)
                       || (field_278.Value && field_279.Value)
                       || (field_280.Value && field_281.Value)
                       || (field_284.Value && field_285.Value)
                       || (field_288.Value && field_289.Value);
                ...
                irq = ((field_383.Value && field_384.Value)
                       || (field_381.Value && field_382.Value));
                if(LogInterrupts && irq)
                {
                    var interruptFlag = 0U;
                    var interruptEnable = 0U;
                ...
                {
                    if(field_371[index].Value && field_372[index].Value)
                    {
                        irq = true;
                        break;
                    }
                ...
                irq = field_335.Value && field_336.Value;
                if(LogInterrupts && irq)
                {
                }
                ...
                irq = field_351.Value && field_352.Value;
                if(LogInterrupts && irq)
                {
                }
                ...
                irq = field_355.Value && field_356.Value;
                if(LogInterrupts && irq)
                {
                }
                SeqTxWrapUpIRQ.Set(irq);

                irq = field_341.Value && field_342.Value;
                if(LogInterrupts && irq)
                {
                }
        ...
        public void PROTIMER_PrsRtcTrigger()
        {
            ...
            if(PROTIMER_rtcWait && field_271.Value)
            {
                field_269.Value = true;
                field_288.Value = true;
                PROTIMER_rtcWait = false;
        ...
        public void PROTIMER_PrsLbtStart()
        {
            if (field_249.Value)
            {
        ...
        public void PROTIMER_PrsLbtStop()
        {
            if (field_250.Value)
            {
                PROTIMER_ListenBeforeTalkStopCommand();
            }
        }

        public void PROTIMER_PrsLbtPause()
        {
            if (field_248.Value)
            {
                PROTIMER_ListenBeforeTalkPauseCommand();
            }
        }
        ...
        public void PROTIMER_TriggerEvent(PROTIMER_Event ev)
        {
            ...
            if (ev >= PROTIMER_Event.CaptureCompareChannel0Event && ev <= PROTIMER_Event.CaptureCompareChannel4Event)
            {
                uint cc = (uint)ev - (uint)PROTIMER_Event.CaptureCompareChannel0Event;
                PROTIMER_CaptureComparePrsEvent[cc]?.Invoke();
            }

            if(ev == PROTIMER_Event.TimeoutCounter0Match && field_254.Value)
            {
                ev = PROTIMER_Event.TimeoutCounter0MatchListenBeforeTalk;
                field_259.Value = true;
                field_284.Value = true;
                UpdateInterrupts();
            }
            ...
            {
                if(field_275.Value == PROTIMER_Event.Always || field_275.Value == ev)
                {
            ...
            case Enumeration_X.EnumerationXValue0:
            {
                if(field_292.Value == PROTIMER_Event.Always)
                {
                    PROTIMER_txRequestState = Enumeration_X.EnumerationXValue1;
                    goto case Enumeration_X.EnumerationXValue1;
                }
                if(field_292.Value == ev)
                {
                    PROTIMER_txRequestState = Enumeration_X.EnumerationXValue1;
                }
                break;
        ...
        public void ReceiveFrame(byte[] frame, IRadio sender)
        {
            ...
            {
                this.Log(LogBasicRadioActivityAsError ? LogLevel.Error : LogLevel.Info, "ReceiveFrame() at {0} on channel {1} ({2}) ({3}Hz): Dropping (TX was aborted)",
                         GetTime(), Channel, MODEM_GetCurrentPhy(), SYNTH_Get2p4Frequency());
                return;
            }

            var txRxSimulatorDelayUs = (GetTime() - txStartTime).TotalMicroseconds;

            this.Log(LogBasicRadioActivityAsError ? LogLevel.Error : LogLevel.Info, "ReceiveFrame() at {0} on channel {1} ({2}) ({3}Hz): TX started at {4} (diff: {5})",
                     GetTime(), Channel, MODEM_GetCurrentPhy(), SYNTH_Get2p4Frequency(), txStartTime, txRxSimulatorDelayUs);
        ...
        public uint PROTIMER_WrapCounterValue
        {
            get
            {
                ...
                if(field_296.Value == Enumeration_Y.EnumerationYValue1
                    && proTimer.Enabled)
                {
                    TrySyncTime();
                    ret += proTimer.Value;
        ...
        private DoubleWordRegisterCollection BuildRfMailboxRegistersCollection()
        {
            var registerDictionary = new Dictionary<long, DoubleWordRegister>
            {
                {(long)Registers_J.RegJ_1, new DoubleWordRegister(this)
                    .WithValueField(0, 32, out field_373[0], name: "REG_J_1_FIELD_1")
                },
                {(long)Registers_J.RegJ_2, new DoubleWordRegister(this)
                    .WithValueField(0, 32, out field_373[1], name: "REG_J_2_FIELD_1")
                },
                {(long)Registers_J.RegJ_3, new DoubleWordRegister(this)
                    .WithValueField(0, 32, out field_373[2], name: "REG_J_3_FIELD_1")
                },
                {(long)Registers_J.RegJ_4, new DoubleWordRegister(this)
                    .WithValueField(0, 32, out field_373[3], name: "REG_J_4_FIELD_1")
                },
                {(long)Registers_J.RegJ_5, new DoubleWordRegister(this)
                    .WithFlag(0, out field_371[0], name: "REG_J_5_FIELD_1")
                    .WithFlag(1, out field_371[1], name: "REG_J_5_FIELD_2")
                    .WithFlag(2, out field_371[2], name: "REG_J_5_FIELD_3")
                    .WithFlag(3, out field_371[3], name: "REG_J_5_FIELD_4")
                    .WithReservedBits(4, 28)
                    .WithChangeCallback((_, __) => UpdateInterrupts())
                },
                {(long)Registers_J.RegJ_6, new DoubleWordRegister(this)
                    .WithFlag(0, out field_372[0], name: "REG_J_6_FIELD_1")
                    .WithFlag(1, out field_372[1], name: "REG_J_6_FIELD_2")
                    .WithFlag(2, out field_372[2], name: "REG_J_6_FIELD_3")
                    .WithFlag(3, out field_372[3], name: "REG_J_6_FIELD_4")
                    .WithReservedBits(4, 28)
                    .WithChangeCallback((_, __) => UpdateInterrupts())
                },
            };
        ...
        private DoubleWordRegisterCollection BuildProtocolTimerRegistersCollection()
        {
            var registerDictionary = new Dictionary<long, DoubleWordRegister>
            {
                {(long)Registers_H.RegH_3, new DoubleWordRegister(this)
                    ...
                    .WithFlag(5, out field_298, name: "REG_H_3_FIELD_4")
                    .WithEnumField<DoubleWordRegister, Enumeration_U>(6, 2, out field_263, changeCallback: (_, value) =>
                        {
                            switch(value)
                            {
                    ...
                    .WithEnumField<DoubleWordRegister, Enumeration_Y>(10, 2, out field_296, changeCallback: (_, value) =>
                        {
                            switch(value)
                            {
                    ...
                    .WithEnumField<DoubleWordRegister, Enumeration_W>(12, 2, out PROTIMER_timeoutCounter[0].Field_394, name: "REG_H_3_FIELD_8")
                    .WithEnumField<DoubleWordRegister, Enumeration_W>(14, 2, out PROTIMER_timeoutCounter[0].Field_395, name: "REG_H_3_FIELD_9")
                    .WithEnumField<DoubleWordRegister, Enumeration_W>(16, 2, out PROTIMER_timeoutCounter[1].Field_394, name: "REG_H_3_FIELD_10")
                    .WithEnumField<DoubleWordRegister, Enumeration_W>(18, 2, out PROTIMER_timeoutCounter[1].Field_395, name: "REG_H_3_FIELD_11")
                    .WithEnumField<DoubleWordRegister, Enumeration_W>(20, 2, out PROTIMER_timeoutCounter[2].Field_394, name: "REG_H_3_FIELD_12")
                    .WithEnumField<DoubleWordRegister, Enumeration_W>(22, 2, out PROTIMER_timeoutCounter[2].Field_395, name: "REG_H_3_FIELD_13")
                ...
                {(long)Registers_H.RegH_4, new DoubleWordRegister(this)
                    .WithFlag(0, FieldMode.Set, writeCallback: (_, value) =>
                        {
                            if(field_263.Value == Enumeration_U.EnumerationUValue1 && value)
                            {
                                PROTIMER_Enabled = true;
                            }
                        }, name: "REG_H_4_FIELD_1")
                    .WithFlag(1, FieldMode.Set, writeCallback: (_, value) => { if(value) PROTIMER_RtcSyncStart(); }, name: "REG_H_4_FIELD_2")
                ...
                {(long)Registers_H.RegH_6, new DoubleWordRegister(this)
                    ...
                    .WithFlag(1, out field_258, FieldMode.Read, name: "REG_H_6_FIELD_2")
                    .WithFlag(2, out field_254, FieldMode.Read, name: "REG_H_6_FIELD_3")
                    .WithFlag(3, out field_247, FieldMode.Read, name: "REG_H_6_FIELD_4")
                    .WithFlag(4, out PROTIMER_timeoutCounter[0].Field_374, FieldMode.Read, name: "REG_H_6_FIELD_5")
                    .WithFlag(5, out PROTIMER_timeoutCounter[0].Field_396, FieldMode.Read, name: "REG_H_6_FIELD_6")
                    .WithFlag(6, out PROTIMER_timeoutCounter[1].Field_374, FieldMode.Read, name: "REG_H_6_FIELD_7")
                    .WithFlag(7, out PROTIMER_timeoutCounter[1].Field_396, FieldMode.Read, name: "REG_H_6_FIELD_8")
                    .WithFlag(8, out PROTIMER_timeoutCounter[2].Field_374, FieldMode.Read, name: "REG_H_6_FIELD_9")
                    .WithFlag(9, out PROTIMER_timeoutCounter[2].Field_396, FieldMode.Read, name: "REG_H_6_FIELD_10")
                ...
                {(long)Registers_H.RegH_14, new DoubleWordRegister(this, 0xFFFF0000)
                    .WithValueField(0, 16, out field_264, name: "REG_H_14_FIELD_1")
                    .WithValueField(16, 16, out field_265, name: "REG_H_14_FIELD_2")
                    .WithWriteCallback((_, __) => PROTIMER_HandleChangedParams())
                },
                ...
                {(long)Registers_H.RegH_16, new DoubleWordRegister(this, 0xFFFFFFFF)
                    .WithValueField(0, 32, out field_297, name: "REG_H_16_FIELD_1")
                    .WithWriteCallback((_, __) => PROTIMER_HandleChangedParams())
                },
                {(long)Registers_H.RegH_17, new DoubleWordRegister(this)
                    .WithValueField(0, 16, out PROTIMER_timeoutCounter[0].Field_299, name: "REG_H_17_FIELD_1")
                ...
                {(long)Registers_H.RegH_18, new DoubleWordRegister(this, 0x00FF00FF)
                    .WithValueField(0, 16, out PROTIMER_timeoutCounter[0].Field_301, name: "REG_H_18_FIELD_1")
                ...
                {(long)Registers_H.RegH_19, new DoubleWordRegister(this)
                    .WithValueField(0, 16, out PROTIMER_timeoutCounter[0].Field_300, name: "REG_H_19_FIELD_1")
                ...
                {(long)Registers_H.RegH_20, new DoubleWordRegister(this)
                    .WithValueField(0, 16, out PROTIMER_timeoutCounter[1].Field_299, name: "REG_H_20_FIELD_1")
                ...
                {(long)Registers_H.RegH_21, new DoubleWordRegister(this, 0x00FF00FF)
                    .WithValueField(0, 16, out PROTIMER_timeoutCounter[1].Field_301, name: "REG_H_21_FIELD_1")
                ...
                {(long)Registers_H.RegH_22, new DoubleWordRegister(this)
                    .WithValueField(0, 16, out PROTIMER_timeoutCounter[1].Field_300, name: "REG_H_22_FIELD_1")
                ...
                {(long)Registers_H.RegH_23, new DoubleWordRegister(this)
                    .WithValueField(0, 16, out PROTIMER_timeoutCounter[2].Field_299, name: "REG_H_23_FIELD_1")
                ...
                {(long)Registers_H.RegH_24, new DoubleWordRegister(this, 0x00FF00FF)
                    .WithValueField(0, 16, out PROTIMER_timeoutCounter[2].Field_301, name: "REG_H_24_FIELD_1")
                ...
                {(long)Registers_H.RegH_25, new DoubleWordRegister(this)
                    .WithValueField(0, 16, out PROTIMER_timeoutCounter[2].Field_300, name: "REG_H_25_FIELD_1")
                ...
                {(long)Registers_H.RegH_32, new DoubleWordRegister(this)
                    ...
                    .WithFlag(24, out PROTIMER_timeoutCounter[0].Field_397, name: "REG_H_32_FIELD_25")
                    .WithFlag(25, out PROTIMER_timeoutCounter[1].Field_397, name: "REG_H_32_FIELD_26")
                    .WithFlag(26, out PROTIMER_timeoutCounter[2].Field_397, name: "REG_H_32_FIELD_27")
                ...
                {(long)Registers_H.RegH_33, new DoubleWordRegister(this)
                    ...
                    .WithFlag(24, out PROTIMER_timeoutCounter[0].Field_398, name: "REG_H_33_FIELD_25")
                    .WithFlag(25, out PROTIMER_timeoutCounter[1].Field_398, name: "REG_H_33_FIELD_26")
                    .WithFlag(26, out PROTIMER_timeoutCounter[2].Field_398, name: "REG_H_33_FIELD_27")
                ...
                {(long)Registers_H.RegH_30, new DoubleWordRegister(this)
                    .WithFlag(0, out field_261, name: "REG_H_30_FIELD_1")
                    .WithFlag(1, out field_235, name: "REG_H_30_FIELD_2")
                    .WithFlag(2, out field_294, name: "REG_H_30_FIELD_3")
                    .WithReservedBits(3, 23)
                    .WithFlag(26, out field_256, name: "REG_H_30_FIELD_4")
                    .WithFlag(27, out field_244, name: "REG_H_30_FIELD_5")
                    .WithTaggedFlag("REG_H_30_FIELD_6", 28)
                    .WithFlag(29, out field_252, name: "REG_H_30_FIELD_7")
                    .WithFlag(30, out field_269, name: "REG_H_30_FIELD_8")
                    .WithFlag(31, out field_259, name: "REG_H_30_FIELD_9")
                    .WithChangeCallback((_, __) => UpdateInterrupts())
                },
                {(long)Registers_H.RegH_31, new DoubleWordRegister(this)
                    .WithFlag(0, out field_262, name: "REG_H_31_FIELD_1")
                    .WithFlag(1, out field_236, name: "REG_H_31_FIELD_2")
                    .WithFlag(2, out field_295, name: "REG_H_31_FIELD_3")
                    .WithReservedBits(3, 23)
                    .WithFlag(26, out field_257, name: "REG_H_31_FIELD_4")
                    .WithFlag(27, out field_245, name: "REG_H_31_FIELD_5")
                    .WithTaggedFlag("REG_H_31_FIELD_6", 28)
                    .WithFlag(29, out field_253, name: "REG_H_31_FIELD_7")
                    .WithFlag(30, out field_270, name: "REG_H_31_FIELD_8")
                    .WithFlag(31, out field_260, name: "REG_H_31_FIELD_9")
                    .WithChangeCallback((_, __) => UpdateInterrupts())
                },
                {(long)Registers_H.RegH_43, new DoubleWordRegister(this)
                    .WithFlag(0, out PROTIMER_captureCompareChannel[0].Field_386, name: "REG_H_43_FIELD_1")
                    .WithFlag(1, out PROTIMER_captureCompareChannel[1].Field_386, name: "REG_H_43_FIELD_2")
                    .WithFlag(2, out PROTIMER_captureCompareChannel[2].Field_386, name: "REG_H_43_FIELD_3")
                    .WithFlag(3, out PROTIMER_captureCompareChannel[3].Field_386, name: "REG_H_43_FIELD_4")
                    .WithFlag(4, out PROTIMER_captureCompareChannel[4].Field_386, name: "REG_H_43_FIELD_5")
                    .WithFlag(5, out PROTIMER_captureCompareChannel[5].Field_386, name: "REG_H_43_FIELD_6")
                    .WithFlag(6, out PROTIMER_captureCompareChannel[6].Field_386, name: "REG_H_43_FIELD_7")
                    .WithFlag(7, out PROTIMER_captureCompareChannel[7].Field_386, name: "REG_H_43_FIELD_8")
                    .WithFlag(8, out PROTIMER_captureCompareChannel[8].Field_386, name: "REG_H_43_FIELD_9")
                    .WithFlag(9, out PROTIMER_captureCompareChannel[9].Field_386, name: "REG_H_43_FIELD_10")
                    .WithFlag(10, out PROTIMER_captureCompareChannel[10].Field_386, name: "REG_H_43_FIELD_11")
                    .WithFlag(11, out PROTIMER_captureCompareChannel[11].Field_386, name: "REG_H_43_FIELD_12")
                    .WithFlag(12, out PROTIMER_captureCompareChannel[0].Field_389, name: "REG_H_43_FIELD_13")
                    .WithFlag(13, out PROTIMER_captureCompareChannel[1].Field_389, name: "REG_H_43_FIELD_14")
                    .WithFlag(14, out PROTIMER_captureCompareChannel[2].Field_389, name: "REG_H_43_FIELD_15")
                    .WithFlag(15, out PROTIMER_captureCompareChannel[3].Field_389, name: "REG_H_43_FIELD_16")
                    .WithFlag(16, out PROTIMER_captureCompareChannel[4].Field_389, name: "REG_H_43_FIELD_17")
                    .WithFlag(17, out PROTIMER_captureCompareChannel[5].Field_389, name: "REG_H_43_FIELD_18")
                    .WithFlag(18, out PROTIMER_captureCompareChannel[6].Field_389, name: "REG_H_43_FIELD_19")
                    .WithFlag(19, out PROTIMER_captureCompareChannel[7].Field_389, name: "REG_H_43_FIELD_20")
                    .WithFlag(20, out PROTIMER_captureCompareChannel[8].Field_389, name: "REG_H_43_FIELD_21")
                    .WithFlag(21, out PROTIMER_captureCompareChannel[9].Field_389, name: "REG_H_43_FIELD_22")
                    .WithFlag(22, out PROTIMER_captureCompareChannel[10].Field_389, name: "REG_H_43_FIELD_23")
                    .WithFlag(23, out PROTIMER_captureCompareChannel[11].Field_389, name: "REG_H_43_FIELD_24")
                    .WithFlag(24, out PROTIMER_timeoutCounter[0].Field_391, name: "REG_H_43_FIELD_25")
                    .WithFlag(25, out PROTIMER_timeoutCounter[1].Field_391, name: "REG_H_43_FIELD_26")
                    .WithFlag(26, out PROTIMER_timeoutCounter[2].Field_391, name: "REG_H_43_FIELD_27")
                    .WithFlag(27, out PROTIMER_timeoutCounter[0].Field_387, name: "REG_H_43_FIELD_28")
                    .WithFlag(28, out PROTIMER_timeoutCounter[1].Field_387, name: "REG_H_43_FIELD_29")
                    .WithFlag(29, out PROTIMER_timeoutCounter[2].Field_387, name: "REG_H_43_FIELD_30")
                    .WithReservedBits(30, 2)
                    .WithChangeCallback((_, __) => UpdateInterrupts())
                },
                {(long)Registers_H.RegH_44, new DoubleWordRegister(this)
                    .WithFlag(0, out PROTIMER_captureCompareChannel[0].Field_385, name: "REG_H_44_FIELD_1")
                    .WithFlag(1, out PROTIMER_captureCompareChannel[1].Field_385, name: "REG_H_44_FIELD_2")
                    .WithFlag(2, out PROTIMER_captureCompareChannel[2].Field_385, name: "REG_H_44_FIELD_3")
                    .WithFlag(3, out PROTIMER_captureCompareChannel[3].Field_385, name: "REG_H_44_FIELD_4")
                    .WithFlag(4, out PROTIMER_captureCompareChannel[4].Field_385, name: "REG_H_44_FIELD_5")
                    .WithFlag(5, out PROTIMER_captureCompareChannel[5].Field_385, name: "REG_H_44_FIELD_6")
                    .WithFlag(6, out PROTIMER_captureCompareChannel[6].Field_385, name: "REG_H_44_FIELD_7")
                    .WithFlag(7, out PROTIMER_captureCompareChannel[7].Field_385, name: "REG_H_44_FIELD_8")
                    .WithFlag(8, out PROTIMER_captureCompareChannel[8].Field_385, name: "REG_H_44_FIELD_9")
                    .WithFlag(9, out PROTIMER_captureCompareChannel[9].Field_385, name: "REG_H_44_FIELD_10")
                    .WithFlag(10, out PROTIMER_captureCompareChannel[10].Field_385, name: "REG_H_44_FIELD_11")
                    .WithFlag(11, out PROTIMER_captureCompareChannel[11].Field_385, name: "REG_H_44_FIELD_12")
                    .WithFlag(12, out PROTIMER_captureCompareChannel[0].Field_390, name: "REG_H_44_FIELD_13")
                    .WithFlag(13, out PROTIMER_captureCompareChannel[1].Field_390, name: "REG_H_44_FIELD_14")
                    .WithFlag(14, out PROTIMER_captureCompareChannel[2].Field_390, name: "REG_H_44_FIELD_15")
                    .WithFlag(15, out PROTIMER_captureCompareChannel[3].Field_390, name: "REG_H_44_FIELD_16")
                    .WithFlag(16, out PROTIMER_captureCompareChannel[4].Field_390, name: "REG_H_44_FIELD_17")
                    .WithFlag(17, out PROTIMER_captureCompareChannel[5].Field_390, name: "REG_H_44_FIELD_18")
                    .WithFlag(18, out PROTIMER_captureCompareChannel[6].Field_390, name: "REG_H_44_FIELD_19")
                    .WithFlag(19, out PROTIMER_captureCompareChannel[7].Field_390, name: "REG_H_44_FIELD_20")
                    .WithFlag(20, out PROTIMER_captureCompareChannel[8].Field_390, name: "REG_H_44_FIELD_21")
                    .WithFlag(21, out PROTIMER_captureCompareChannel[9].Field_390, name: "REG_H_44_FIELD_22")
                    .WithFlag(22, out PROTIMER_captureCompareChannel[10].Field_390, name: "REG_H_44_FIELD_23")
                    .WithFlag(23, out PROTIMER_captureCompareChannel[11].Field_390, name: "REG_H_44_FIELD_24")
                    .WithFlag(24, out PROTIMER_timeoutCounter[0].Field_392, name: "REG_H_44_FIELD_25")
                    .WithFlag(25, out PROTIMER_timeoutCounter[1].Field_392, name: "REG_H_44_FIELD_26")
                    .WithFlag(26, out PROTIMER_timeoutCounter[2].Field_392, name: "REG_H_44_FIELD_27")
                    .WithFlag(27, out PROTIMER_timeoutCounter[0].Field_388, name: "REG_H_44_FIELD_28")
                    .WithFlag(28, out PROTIMER_timeoutCounter[1].Field_388, name: "REG_H_44_FIELD_29")
                    .WithFlag(29, out PROTIMER_timeoutCounter[2].Field_388, name: "REG_H_44_FIELD_30")
                    .WithReservedBits(30, 2)
                    .WithChangeCallback((_, __) => UpdateInterrupts())
                },
                {(long)Registers_H.RegH_41, new DoubleWordRegister(this)
                    .WithFlag(0, out field_286, name: "REG_H_41_FIELD_1")
                    .WithFlag(1, out field_276, name: "REG_H_41_FIELD_2")
                    .WithFlag(2, out field_290, name: "REG_H_41_FIELD_3")
                    .WithReservedBits(3, 23)
                    .WithFlag(26, out field_282, name: "REG_H_41_FIELD_4")
                    .WithFlag(27, out field_278, name: "REG_H_41_FIELD_5")
                    .WithTaggedFlag("REG_H_41_FIELD_6", 28)
                    .WithFlag(29, out field_280, name: "REG_H_41_FIELD_7")
                    .WithFlag(30, out field_288, name: "REG_H_41_FIELD_8")
                    .WithFlag(31, out field_284, name: "REG_H_41_FIELD_9")
                    .WithChangeCallback((_, __) => UpdateInterrupts())
                },
                {(long)Registers_H.RegH_42, new DoubleWordRegister(this)
                    .WithFlag(0, out field_287, name: "REG_H_42_FIELD_1")
                    .WithFlag(1, out field_277, name: "REG_H_42_FIELD_2")
                    .WithFlag(2, out field_291, name: "REG_H_42_FIELD_3")
                    .WithReservedBits(3, 23)
                    .WithFlag(26, out field_283, name: "REG_H_42_FIELD_4")
                    .WithFlag(27, out field_279, name: "REG_H_42_FIELD_5")
                    .WithTaggedFlag("REG_H_42_FIELD_6", 28)
                    .WithFlag(29, out field_281, name: "REG_H_42_FIELD_7")
                    .WithFlag(30, out field_289, name: "REG_H_42_FIELD_8")
                    .WithFlag(31, out field_285, name: "REG_H_42_FIELD_9")
                    .WithChangeCallback((_, __) => UpdateInterrupts())
                },
                {(long)Registers_H.RegH_34, new DoubleWordRegister(this)
                    .WithEnumField<DoubleWordRegister, PROTIMER_Event>(0, 6, out field_274, name: "REG_H_34_FIELD_1")
                    .WithReservedBits(6, 2)
                    .WithEnumField<DoubleWordRegister, PROTIMER_Event>(8, 6, out field_275, name: "REG_H_34_FIELD_2")
                    .WithReservedBits(14, 2)
                    .WithEnumField<DoubleWordRegister, PROTIMER_Event>(16, 6, out field_272, name: "REG_H_34_FIELD_3")
                    .WithReservedBits(22, 2)
                    .WithEnumField<DoubleWordRegister, PROTIMER_Event>(24, 6, out field_273, name: "REG_H_34_FIELD_4")
                    .WithReservedBits(30, 2)
                    .WithChangeCallback((_, __) => PROTIMER_UpdateRxRequestState())
                },
                {(long)Registers_H.RegH_35, new DoubleWordRegister(this)
                    .WithEnumField<DoubleWordRegister, PROTIMER_Event>(0, 6, out field_292, name: "REG_H_35_FIELD_1")
                    .WithReservedBits(6, 2)
                    .WithEnumField<DoubleWordRegister, PROTIMER_Event>(8, 6, out field_293, name: "REG_H_35_FIELD_2")
                    .WithReservedBits(14, 18)
                    .WithChangeCallback((_, __) => PROTIMER_UpdateTxRequestState())
                },
                {(long)Registers_H.RegH_26, new DoubleWordRegister(this)
                    .WithValueField(0, 4, out field_255, name: "REG_H_26_FIELD_1")
                    ...
                    .WithValueField(24, 4, out field_268, name: "REG_H_26_FIELD_6")
                ...
                {(long)Registers_H.RegH_37, new DoubleWordRegister(this)
                    ...
                    .WithValueField(8, 4, out field_251, name: "REG_H_37_FIELD_3")
                ...
                {(long)Registers_H.RegH_47, new DoubleWordRegister(this)
                    .WithValueField(0, 9, out field_266, name: "REG_H_47_FIELD_1")
                    .WithReservedBits(9, 7)
                    .WithValueField(16, 9, out field_267, name: "REG_H_47_FIELD_2")
                    .WithReservedBits(25, 7)
                },
                {(long)Registers_H.RegH_5, new DoubleWordRegister(this)
                    .WithReservedBits(0, 1)
                    .WithTaggedFlag("REG_H_5_FIELD_1", 1)
                    .WithTag("REG_H_5_FIELD_2", 2, 2)
                    .WithReservedBits(4, 5)
                    .WithTaggedFlag("REG_H_5_FIELD_3", 9)
                    .WithTag("REG_H_5_FIELD_4", 10, 2)
                    .WithReservedBits(12, 5)
                    .WithFlag(17, out field_271, name: "REG_H_5_FIELD_5")
                    .WithTag("REG_H_5_FIELD_6", 18, 2)
                    .WithReservedBits(20, 12)
                },
                {(long)Registers_H.RegH_27, new DoubleWordRegister(this)
                    .WithReservedBits(0, 8)
                    .WithFlag(8, out field_249, name: "REG_H_27_FIELD_1")
                    .WithReservedBits(9, 7)
                    .WithFlag(16, out field_248, name: "REG_H_27_FIELD_2")
                    .WithReservedBits(17, 7)
                    .WithFlag(24, out field_250, name: "REG_H_27_FIELD_3")
                    .WithReservedBits(25, 7)
                },
            };
            ...
            for(var index = 0; index < PROTIMER_NumberOfCaptureCompareChannels; index++)
            {
                ...
                registerDictionary.Add(startOffset + blockSize * i + controlOffset,
                    new DoubleWordRegister(this)
                        .WithFlag(0, out PROTIMER_captureCompareChannel[i].Field_56, name: "REG_H_27_FIELD_4")
                        .WithEnumField<DoubleWordRegister, Enumeration_Q>(1, 2, out PROTIMER_captureCompareChannel[i].Field_231, name: "REG_H_27_FIELD_5")
                        .WithFlag(3, out PROTIMER_captureCompareChannel[i].Field_302, name: "REG_H_27_FIELD_6")
                        .WithFlag(4, out PROTIMER_captureCompareChannel[i].Field_43, name: "REG_H_27_FIELD_7")
                        .WithFlag(5, out PROTIMER_captureCompareChannel[i].Field_402, name: "REG_H_27_FIELD_8")
                        .WithTaggedFlag("REG_H_27_FIELD_9", 6)
                        .WithTaggedFlag("REG_H_27_FIELD_10", 7)
                        .WithTag("REG_H_27_FIELD_11", 8, 2)
                        .WithTag("REG_H_27_FIELD_12", 10, 2)
                        .WithTag("REG_H_27_FIELD_13", 12, 2)
                        .WithTaggedFlag("REG_H_27_FIELD_14", 14)
                        .WithReservedBits(15, 6)
                        .WithEnumField<DoubleWordRegister, Enumeration_R>(21, 4, out PROTIMER_captureCompareChannel[i].Field_50, name: "REG_H_27_FIELD_15")
                        .WithTag("REG_H_27_FIELD_16", 25, 2)
                        .WithReservedBits(27, 5)
                ...
                registerDictionary.Add(startOffset + blockSize * i + preOffset,
                    new DoubleWordRegister(this)
                        .WithValueField(0, 16, out PROTIMER_captureCompareChannel[i].Field_303,
                            writeCallback: (_, __) =>
                            {
                            ...
                            {
                                PROTIMER_captureCompareChannel[i].Field_51.Value = false;
                                return PROTIMER_captureCompareChannel[i].Field_303.Value;
                            }, name: "REG_H_27_FIELD_17")
                        .WithReservedBits(16, 16)
                );
                ...
                registerDictionary.Add(startOffset + blockSize * i + baseOffset,
                    new DoubleWordRegister(this)
                        .WithValueField(0, 32, out PROTIMER_captureCompareChannel[i].Field_44,
                            ...
                            }, name: "REG_H_27_FIELD_18")
                );

                registerDictionary.Add(startOffset + blockSize * i + wrapOffset,
                    new DoubleWordRegister(this)
                        .WithValueField(0, 32, out PROTIMER_captureCompareChannel[i].Field_403,
                            writeCallback: (_, __) => { PROTIMER_captureCompareChannel[i].Field_51.Value = false; },
                            valueProviderCallback: _ =>
                            {
                                PROTIMER_captureCompareChannel[i].Field_51.Value = false;
                                return PROTIMER_captureCompareChannel[i].Field_403.Value;
                            }, name: "REG_H_27_FIELD_19")
                );

                registerDictionary.Add(startOffset + blockSize * i + wrapLowLimitOffset,
                    new DoubleWordRegister(this)
                        .WithValueField(0, 32, out PROTIMER_captureCompareChannel[i].Field_401,
                            writeCallback: (_, __) =>
                            {
                            ...
                            valueProviderCallback: _ =>
                            {
                                ...
                                return 0;
                            }, name: "REG_H_27_FIELD_20")
                );

                registerDictionary.Add(startOffset + blockSize * i + wrapHighLimitOffset,
                    new DoubleWordRegister(this)
                        .WithValueField(0, 32, out PROTIMER_captureCompareChannel[i].Field_400,
                            writeCallback: (_, __) =>
                            {
        ...
        private DoubleWordRegisterCollection BuildRadioControllerRegistersCollection()
        {
            var registerDictionary = new Dictionary<long, DoubleWordRegister>
            {
                {(long)Registers_I.RegI_3, new DoubleWordRegister(this)
                    .WithValueField(0, 8, out field_363, name: "REG_I_3_FIELD_1")
                ...
                {(long)Registers_I.RegI_4, new DoubleWordRegister(this)
                    ...
                    .WithFlag(19, out field_306, FieldMode.Read, name: "REG_I_4_FIELD_2")
                    .WithReservedBits(20, 2)
                    .WithFlag(22, out field_362, FieldMode.Read, name: "REG_I_4_FIELD_3")
                    .WithFlag(23, out field_361, FieldMode.Read, name: "REG_I_4_FIELD_4")
                    ...
                    .WithFlag(28, out field_360, FieldMode.Read, name: "REG_I_4_FIELD_6")
                ...
                {(long)Registers_I.RegI_6, new DoubleWordRegister(this)
                    .WithFlag(0, out field_305, writeCallback: (_, value) => { if (value) {RAC_UpdateRadioStateMachine();} }, name: "REG_I_6_FIELD_1")
                    ...
                    .WithFlag(25, out field_304, FieldMode.Read, name: "REG_I_6_FIELD_21")
                ...
                {(long)Registers_I.RegI_7, new DoubleWordRegister(this)
                    .WithEnumField<DoubleWordRegister, Enumeration_AB>(0, 4, out field_307, writeCallback: (_, __) =>
                        {
                            field_306.Value = true;
                ...
                {(long)Registers_I.RegI_8, new DoubleWordRegister(this)
                    .WithFlag(0, out field_311, name: "REG_I_8_FIELD_1")
                    .WithFlag(1, out field_364, name: "REG_I_8_FIELD_2")
                    ...
                    .WithReservedBits(7, 1)
                    .WithValueField(8, 24, out field_308, name: "REG_I_8_FIELD_8")
                    .WithChangeCallback((_, __) => UpdateInterrupts())
                },
                {(long)Registers_I.RegI_9, new DoubleWordRegister(this)
                    .WithFlag(0, out field_312, name: "REG_I_9_FIELD_1")
                    .WithFlag(1, out field_365, name: "REG_I_9_FIELD_2")
                    ...
                    .WithReservedBits(7, 1)
                    .WithValueField(8, 24, out field_309, name: "REG_I_9_FIELD_8")
                    .WithChangeCallback((_, __) => UpdateInterrupts())
                },
                {(long)Registers_I.RegI_11, new DoubleWordRegister(this)
                    .WithFlag(0, out field_319, name: "REG_I_11_FIELD_1")
                    .WithFlag(1, out field_357, name: "REG_I_11_FIELD_2")
                    .WithFlag(2, out field_315, name: "REG_I_11_FIELD_3")
                    .WithFlag(3, out field_317, name: "REG_I_11_FIELD_4")
                    .WithReservedBits(4, 2)
                    .WithTaggedFlag("REG_I_11_FIELD_5", 6)
                    .WithReservedBits(7, 9)
                    .WithFlag(16, out field_323, changeCallback: (_, value) => {if (!value) {RAC_UpdateRadioStateMachine(Enumeration_AC.EnumerationACValue25);}}, name: "REG_I_11_FIELD_6")
                    .WithFlag(17, out field_335, changeCallback: (_, value) => {if (!value) {RAC_UpdateRadioStateMachine(Enumeration_AC.EnumerationACValue20);}}, name: "REG_I_11_FIELD_7")
                    .WithFlag(18, out field_331, changeCallback: (_, value) => {if (!value) {RAC_UpdateRadioStateMachine(Enumeration_AC.EnumerationACValue21);}}, name: "REG_I_11_FIELD_8")
                    .WithFlag(19, out field_327, changeCallback: (_, value) => {if (!value) {RAC_UpdateRadioStateMachine(Enumeration_AC.EnumerationACValue22);}}, name: "REG_I_11_FIELD_9")
                    .WithFlag(20, out field_339, changeCallback: (_, value) => {if (!value) {RAC_UpdateRadioStateMachine(Enumeration_AC.EnumerationACValue23);}}, name: "REG_I_11_FIELD_10")
                    .WithFlag(21, out field_351, changeCallback: (_, value) => {if (!value) {RAC_UpdateRadioStateMachine(Enumeration_AC.EnumerationACValue17);}}, name: "REG_I_11_FIELD_11")
                    .WithFlag(22, out field_347, name: "REG_I_11_FIELD_12")
                    .WithFlag(23, out field_355, changeCallback: (_, value) => {if (!value) {RAC_UpdateRadioStateMachine(Enumeration_AC.EnumerationACValue19);}}, name: "REG_I_11_FIELD_13")
                    .WithFlag(24, out field_341, changeCallback: (_, value) => {if (!value) {RAC_UpdateRadioStateMachine(Enumeration_AC.EnumerationACValue24);}}, name: "REG_I_11_FIELD_14")
                ...
                {(long)Registers_I.RegI_12, new DoubleWordRegister(this)
                    .WithFlag(0, out field_320, name: "REG_I_12_FIELD_1")
                    .WithFlag(1, out field_358, name: "REG_I_12_FIELD_2")
                    .WithFlag(2, out field_316, name: "REG_I_12_FIELD_3")
                    .WithFlag(3, out field_318, name: "REG_I_12_FIELD_4")
                    .WithReservedBits(4, 2)
                    .WithTaggedFlag("REG_I_12_FIELD_5", 6)
                    .WithReservedBits(7, 9)
                    .WithFlag(16, out field_324, name: "REG_I_12_FIELD_6")
                    .WithFlag(17, out field_336, name: "REG_I_12_FIELD_7")
                    .WithFlag(18, out field_332, name: "REG_I_12_FIELD_8")
                    .WithFlag(19, out field_328, name: "REG_I_12_FIELD_9")
                    .WithFlag(20, out field_340, name: "REG_I_12_FIELD_10")
                    .WithFlag(21, out field_352, name: "REG_I_12_FIELD_11")
                    .WithFlag(22, out field_348, name: "REG_I_12_FIELD_12")
                    .WithFlag(23, out field_356, name: "REG_I_12_FIELD_13")
                    .WithFlag(24, out field_342, name: "REG_I_12_FIELD_14")
                    .WithReservedBits(25, 3)
                ...
                {(long)Registers_I.RegI_16, new DoubleWordRegister(this)
                    .WithEnumField<DoubleWordRegister, Enumeration_AB>(0, 4, out field_369, name: "REG_I_16_FIELD_1")
                    .WithReservedBits(4, 28)
                },
                {(long)Registers_I.RegI_17, new DoubleWordRegister(this)
                    .WithEnumField<DoubleWordRegister, Enumeration_AB>(0, 4, out field_313, name: "REG_I_17_FIELD_1")
                    .WithReservedBits(4, 28)
                },
                {(long)Registers_I.RegI_18, new DoubleWordRegister(this)
                    .WithReservedBits(0, 16)
                    .WithFlag(16, out field_321, changeCallback: (_, value) => {if (!value) {RAC_UpdateRadioStateMachine(Enumeration_AC.EnumerationACValue25);}}, name: "REG_I_18_FIELD_1")
                    .WithFlag(17, out field_333, changeCallback: (_, value) => {if (!value) {RAC_UpdateRadioStateMachine(Enumeration_AC.EnumerationACValue20);}}, name: "REG_I_18_FIELD_2")
                    .WithFlag(18, out field_329, changeCallback: (_, value) => {if (!value) {RAC_UpdateRadioStateMachine(Enumeration_AC.EnumerationACValue21);}}, name: "REG_I_18_FIELD_3")
                    .WithFlag(19, out field_325, changeCallback: (_, value) => {if (!value) {RAC_UpdateRadioStateMachine(Enumeration_AC.EnumerationACValue22);}}, name: "REG_I_18_FIELD_4")
                    .WithFlag(20, out field_337, changeCallback: (_, value) => {if (!value) {RAC_UpdateRadioStateMachine(Enumeration_AC.EnumerationACValue23);}}, name: "REG_I_18_FIELD_5")
                    .WithFlag(21, out field_349, changeCallback: (_, value) => {if (!value) {RAC_UpdateRadioStateMachine(Enumeration_AC.EnumerationACValue17);}}, name: "REG_I_18_FIELD_6")
                    .WithFlag(22, out field_345, name: "REG_I_18_FIELD_7")
                    .WithFlag(23, out field_353, changeCallback: (_, value) => {if (!value) {RAC_UpdateRadioStateMachine(Enumeration_AC.EnumerationACValue19);}}, name: "REG_I_18_FIELD_8")
                    .WithFlag(24, out field_343, changeCallback: (_, value) => {if (!value) {RAC_UpdateRadioStateMachine(Enumeration_AC.EnumerationACValue24);}}, name: "REG_I_18_FIELD_9")
                    .WithReservedBits(25, 7)
                },
                {(long)Registers_I.RegI_19, new DoubleWordRegister(this)
                    .WithReservedBits(0, 16)
                    .WithFlag(16, out field_322, name: "REG_I_19_FIELD_1")
                    .WithFlag(17, out field_334, name: "REG_I_19_FIELD_2")
                    .WithFlag(18, out field_330, name: "REG_I_19_FIELD_3")
                    .WithFlag(19, out field_326, name: "REG_I_19_FIELD_4")
                    .WithFlag(20, out field_338, name: "REG_I_19_FIELD_5")
                    .WithFlag(21, out field_350, name: "REG_I_19_FIELD_6")
                    .WithFlag(22, out field_346, name: "REG_I_19_FIELD_7")
                    .WithFlag(23, out field_354, name: "REG_I_19_FIELD_8")
                    .WithFlag(24, out field_344, name: "REG_I_19_FIELD_9")
                    .WithReservedBits(25, 7)
                },
                ...
                {(long)Registers_I.RegI_29, new DoubleWordRegister(this)
                    .WithValueField(0, 32, out field_359[0], name: "REG_I_29_FIELD_1")
                },
                {(long)Registers_I.RegI_30, new DoubleWordRegister(this)
                    .WithValueField(0, 32, out field_359[1], name: "REG_I_30_FIELD_1")
                },
                {(long)Registers_I.RegI_31, new DoubleWordRegister(this)
                    .WithValueField(0, 32, out field_359[2], name: "REG_I_31_FIELD_1")
                },
                {(long)Registers_I.RegI_32, new DoubleWordRegister(this)
                    .WithValueField(0, 32, out field_359[3], name: "REG_I_32_FIELD_1")
                },
                {(long)Registers_I.RegI_38, new DoubleWordRegister(this)
                    .WithFlag(0, out field_310, FieldMode.Read, name: "REG_I_38_FIELD_1")
                    .WithReservedBits(1, 31)
                },
                ...
                {(long)Registers_I.RegI_131, new DoubleWordRegister(this)
                    .WithValueField(0, 32, out field_314[0], name: "REG_I_131_FIELD_1")
                },
                {(long)Registers_I.RegI_132, new DoubleWordRegister(this)
                    .WithValueField(0, 32, out field_314[1], name: "REG_I_132_FIELD_1")
                },
                {(long)Registers_I.RegI_133, new DoubleWordRegister(this)
                    .WithValueField(0, 32, out field_314[2], name: "REG_I_133_FIELD_1")
                },
                {(long)Registers_I.RegI_134, new DoubleWordRegister(this)
                    .WithValueField(0, 32, out field_314[3], name: "REG_I_134_FIELD_1")
                },
                {(long)Registers_I.RegI_135, new DoubleWordRegister(this)
                    .WithValueField(0, 32, out field_314[4], name: "REG_I_135_FIELD_1")
                },
                {(long)Registers_I.RegI_136, new DoubleWordRegister(this)
                    .WithValueField(0, 32, out field_314[5], name: "REG_I_136_FIELD_1")
                },
                {(long)Registers_I.RegI_137, new DoubleWordRegister(this)
                    .WithValueField(0, 32, out field_314[6], name: "REG_I_137_FIELD_1")
                },
                {(long)Registers_I.RegI_138, new DoubleWordRegister(this)
                    .WithValueField(0, 32, out field_314[7], name: "REG_I_138_FIELD_1")
                },
                {(long)Registers_I.RegI_144, new DoubleWordRegister(this, 0x80000000)
                    ...
                    .WithFlag(31, out field_370, name: "REG_I_144_FIELD_11")
                },
                ...
                {(long)Registers_I.RegI_37, new DoubleWordRegister(this)
                    .WithReservedBits(0, 9)
                    .WithTaggedFlag("REG_I_37_FIELD_1", 9)
                    .WithReservedBits(10, 10)
                    .WithFlag(20, out field_368, name: "REG_I_37_FIELD_2")
                    .WithReservedBits(21, 11)
                },
                {(long)Registers_I.RegI_85, new DoubleWordRegister(this, 0x00000080)
                    .WithTaggedFlag("REG_I_85_FIELD_1", 0)
                    .WithEnumField<DoubleWordRegister, Enumeration_AD>(1, 1, out field_366, name: "REG_I_85_FIELD_2")
                    .WithReservedBits(2, 2)
                    .WithTaggedFlag("REG_I_85_FIELD_3", 4)
                    .WithEnumField<DoubleWordRegister, Enumeration_AD>(5, 1, out field_367, name: "REG_I_85_FIELD_4")
                    .WithTag("REG_I_85_FIELD_5", 6, 3)
                    .WithReservedBits(9, 7)
                    .WithTag("REG_I_85_FIELD_6", 16, 3)
                    .WithReservedBits(19, 13)
                },
                {(long)Registers_I.RegI_60, new DoubleWordRegister(this, 0x03FC0201)
                    .WithTaggedFlag("REG_I_60_FIELD_1", 0)
                    .WithTaggedFlag("REG_I_60_FIELD_2", 1)
                    .WithTag("REG_I_60_FIELD_3", 2, 8)
                    .WithTag("REG_I_60_FIELD_4", 10, 8)
                    .WithTag("REG_I_60_FIELD_5", 18, 8)
                    .WithReservedBits(26, 5)
                    .WithTaggedFlag("REG_I_60_FIELD_6", 31)
                },
            };
            return new DoubleWordRegisterCollection(this, registerDictionary);
        }
        ...
        private DoubleWordRegisterCollection BuildSynthesizerRegistersCollection()
        {
            var registerDictionary = new Dictionary<long, DoubleWordRegister>
            {
                ...
                {(long)Registers_K.RegK_9, new DoubleWordRegister(this)
                    ...
                    .WithFlag(1, out field_378, FieldMode.Read, name: "REG_K_9_FIELD_2")
                    .WithFlag(2, FieldMode.Read, valueProviderCallback: _ => (SYNTH_state == Enumeration_AE.EnumerationAEValue1), name: "REG_K_9_FIELD_3")
                    .WithTaggedFlag("REG_K_9_FIELD_4", 3)
                    .WithTag("REG_K_9_FIELD_5", 4, 13)
                    .WithReservedBits(17, 15)
                },
                {(long)Registers_K.RegK_13, new DoubleWordRegister(this)
                    .WithValueField(0, 28, out field_377, name: "REG_K_13_FIELD_1")
                    .WithReservedBits(28, 4)
                },

                {(long)Registers_K.RegK_17, new DoubleWordRegister(this)
                    .WithValueField(0, 18, valueProviderCallback: _ => (ulong)Channel, writeCallback: (_, value) => { Channel = (int)value; }, name: "REG_K_17_FIELD_1")
                    .WithReservedBits(18, 14)
                },
            };
        ...
        private DoubleWordRegisterCollection BuildFrameControllerRegistersCollection()
        {
            ...
            for(var index = 0; index < FRC_NumberOfFrameDescriptors; index++)
            {
                ...
                registerDictionary.Add(startOffset + blockSize * i,
                    new DoubleWordRegister(this)
                        .WithValueField(0, 8, out FRC_frameDescriptor[i].Field_399, name: "REG_C_32_FIELD_2")
                        ...
                        .WithFlag(14, out FRC_frameDescriptor[i].Field_393, name: "REG_C_32_FIELD_7")
        ...
        {
            if(field_292.Value == PROTIMER_Event.Disabled
                && field_293.Value == PROTIMER_Event.Disabled)
            {
                PROTIMER_rxRequestState = Enumeration_X.EnumerationXValue0;
            }
        }
        ...
        private void PROTIMER_TimeoutCounter0HandleSynchronize()
        {
            if(field_258.Value)
            {
                field_258.Value = false;
                field_254.Value = true;
            }
        }
        ...
        private void PROTIMER_ListenBeforeTalkCcaCompleted(bool forceFailure = false)
        {
            ...
            if(!field_1.Value)
            {
                ...
                if(field_251.Value == field_268.Value)
                {
                    PROTIMER_listenBeforeTalkState = Enumeration_S.EnumerationSValue0;
                    field_258.Value = false;
                    field_254.Value = false;
                ...
                {
                    field_252.Value = true;
                    field_280.Value = true;
                    UpdateInterrupts();
        ...
        {
            if(PROTIMER_timeoutCounter[0].Field_374.Value || PROTIMER_timeoutCounter[0].Field_396.Value)
            {
            ...
            field_243.Value = field_255.Value;

            field_251.Value = 0;

            PROTIMER_listenBeforeTalkState = Enumeration_S.EnumerationSValue1;

            if(PROTIMER_timeoutCounter[0].Field_395.Value == Enumeration_W.EnumerationWValue0)
            {
                field_254.Value = true;
            }
            else
            {
                field_258.Value = true;
            }
        ...
        private void PROTIMER_IncrementBaseCounter(uint increment = 1)
        {
            ...
            for(uint i = 0; i < PROTIMER_NumberOfCaptureCompareChannels; ++i)
            {
                ...
                if(triggered)
                {
                    ...
                    PROTIMER_captureCompareChannel[i].Field_386.Value = true;
                    UpdateInterrupts();
        ...
        private void PROTIMER_UpdateCompareTimer(int index)
        {
            ...
            if(PROTIMER_captureCompareChannel[index].Field_56.Value
                ...
                && PROTIMER_captureCompareChannel[index].Field_302.Value)
            {
        ...
        private void PROTIMER_IncrementWrapCounter(uint increment = 1)
        {
            ...
            {
                var triggered = PROTIMER_captureCompareChannel[i].Field_56.Value
                    && PROTIMER_captureCompareChannel[i].Field_402.Value
                    && PROTIMER_captureCompareChannel[i].Field_231.Value == Enumeration_Q.EnumerationQValue0
                    && PROTIMER_wrapCounterValue == PROTIMER_captureCompareChannel[i].Field_403.Value;
            ...
            if(PROTIMER_wrapCounterValue >= field_297.Value)
            {
        ...
        {
            if(field_272.Value == PROTIMER_Event.Always
                && field_273.Value == PROTIMER_Event.Always)
            {
                PROTIMER_rxRequestState = Enumeration_X.EnumerationXValue0;
            }
            else if(field_274.Value == PROTIMER_Event.Always
                     && field_275.Value == PROTIMER_Event.Always)
            {
        ...
        private void PROTIMER_HandleBaseCounterOverflow()
        {
            ...
            if(field_296.Value == Enumeration_Y.EnumerationYValue2)
            {
        ...
        private uint PROTIMER_GetPreCntOverflowFrequency()
        {
            ...
            double frequency = (double)HfxoFrequency / (field_265.Value + 1 + ((double)field_264.Value / 65536));
        ...
        private uint PROTIMER_ComputeTimerLimit()
        {
            ...
            if(field_296.Value == Enumeration_Y.EnumerationYValue1)
            {
                if(PROTIMER_wrapCounterValue > field_297.Value)
                {
                    this.Log(LogLevel.Error, "WRAPCNT > WRAPCNTTOP {0} {1}", PROTIMER_wrapCounterValue, field_297.Value);
                    throw new Exception("WRAPCNT > WRAPCNTTOP");
                }

                uint temp = (uint)field_297.Value - PROTIMER_wrapCounterValue;
                if(temp != 0 && temp < limit)
                {
                    limit = temp;
                }
            ...
            {
                if((PROTIMER_timeoutCounter[i].Field_396.Value
                     && PROTIMER_timeoutCounter[i].Field_395.Value == Enumeration_W.EnumerationWValue1)
                    || (PROTIMER_timeoutCounter[i].Field_374.Value
                        && PROTIMER_timeoutCounter[i].Field_394.Value == Enumeration_W.EnumerationWValue1))
                {
            ...
            for(int i = 0; i < PROTIMER_NumberOfCaptureCompareChannels; i++)
            {
                    ...
                    && PROTIMER_captureCompareChannel[i].Field_231.Value == Enumeration_Q.EnumerationQValue0)
                {
                    ...
                    if(PROTIMER_captureCompareChannel[i].Field_402.Value
                        && field_296.Value == Enumeration_Y.EnumerationYValue1
                        && PROTIMER_captureCompareChannel[i].Field_403.Value > PROTIMER_wrapCounterValue)
                    {
                        uint temp = (uint)(PROTIMER_captureCompareChannel[i].Field_403.Value - PROTIMER_wrapCounterValue);
                        if(temp < limit)
                        {
                            limit = temp;
                        }
        ...
        private void PROTIMER_RtcCapture(uint channel)
        {
            if(channel > 1)
            {
                this.Log(LogLevel.Error, "PROTIMER_RtcCapture: invalid channel {0}", channel);
                return;
            }
            ...
            for(var i = 0; i < PROTIMER_NumberOfCaptureCompareChannels; ++i)
            {
                if(PROTIMER_captureCompareChannel[i].Field_56.Value
                    ...
                    && PROTIMER_captureCompareChannel[i].Field_50.Value == (Enumeration_R)((uint)Enumeration_R.EnumerationRValue11 + channel))
                {
        ...
        {
            if(SYNTH_state == Enumeration_AE.EnumerationAEValue2)
            {
                field_375.Value = true;
                field_381.Value = true;
                UpdateInterrupts();
            }
        }
        ...
        {
            SYNTH_state = Enumeration_AE.EnumerationAEValue2;
        ...
        {
            field_378.Value = false;
        }

        private void SYNTH_EnableIf()
        {
            field_378.Value = true;
        }
        ...
        private void SYNTH_Start()
        {
            ...
            if(SYNTH_state == Enumeration_AE.EnumerationAEValue2)
            {
                SYNTH_state = Enumeration_AE.EnumerationAEValue1;
                field_379.Value = true;
                field_383.Value = true;
                UpdateInterrupts();
            }
        }

        private ulong SYNTH_Get2p4Frequency()
        {
            var divider = (ulong)((field_368.Value) ? field_367.Value : field_366.Value) + 1;
            return field_377.Value * HfxoFrequency / (1 << 19) / divider;
        }
        ...
        private void FRC_SnifferTransmitFrame(byte[] frame)
        {
        ...
        private void FRC_DisassembleCurrentFrame(bool forceCrcError)
        {
...

            {
                ...
                if(field_97.Value)
                {
                    bufferController.WriteData(descriptor.BufferIndex, ((uint)PROTIMER_captureCompareChannel[0].Field_403.Value & 0xFF));
                    bufferController.WriteData(descriptor.BufferIndex, (((uint)PROTIMER_captureCompareChannel[0].Field_403.Value >> 8) & 0xFF));
                }
                if(field_96.Value)
                {
                    bufferController.WriteData(descriptor.BufferIndex, (((uint)PROTIMER_captureCompareChannel[0].Field_403.Value >> 16) & 0xFF));
                    bufferController.WriteData(descriptor.BufferIndex, (((uint)PROTIMER_captureCompareChannel[0].Field_403.Value >> 24) & 0xFF));
                }
            }
        ...
        private void RAC_PaRampingTimerHandleLimitReached()
        {
            ...
            MODEM_TxRampingDoneInterrupt = true;
            field_310.Value = RAC_paOutputLevelRamping;
            UpdateInterrupts();
        }
        ...
        private void RAC_UpdateRadioStateMachine(Enumeration_AC signal = Enumeration_AC.EnumerationACValue0)
        {
            ...
            machine.ClockSource.ExecuteInLock(delegate
            {
                ...
                else if(field_306.Value)
                {
                    RAC_ClearOngoingTxOrRx();
                    RAC_ChangeRadioState(field_307.Value);
                    field_306.Value = false;
                }
                else if(field_305.Value && RAC_currentRadioState == Enumeration_AB.EnumerationABValue0)
                {

                }
                else if(field_305.Value && RAC_currentRadioState != Enumeration_AB.EnumerationABValue8)
                {
                    RAC_ClearOngoingTxOrRx();
                    RAC_ChangeRadioState(Enumeration_AB.EnumerationABValue8);
                }
                ...
                else
                {
                    ...
                    case Enumeration_AB.EnumerationABValue8:
                    {
                        ...
                        if(!field_341.Value
                            && (!field_344.Value || !field_343.Value)
                            && !field_304.Value)
                        {
                    ...
                    case Enumeration_AB.EnumerationABValue5:
                    {
                        ...
                        if(signal == Enumeration_AC.EnumerationACValue17
                            && !field_351.Value
                            && (!field_350.Value || !field_349.Value))
                        {
                            if(RAC_TxEnable)
                            {
                    ...
                    case Enumeration_AB.EnumerationABValue7:
                    {
                        ...
                        if(signal == Enumeration_AC.EnumerationACValue19
                            && !field_339.Value
                            && (!field_338.Value || !field_337.Value))
                        {
                            if(field_369.Value == Enumeration_AB.EnumerationABValue6
                                && !RAC_TxEnable)
                            {

                            }
                            else if(field_369.Value == Enumeration_AB.EnumerationABValue2
                                     && !RAC_RxEnable)
                            {
                                RAC_ChangeRadioState(Enumeration_AB.EnumerationABValue4);
                            }
                            else if(field_369.Value == Enumeration_AB.EnumerationABValue6
                                     && RAC_TxEnable)
                            {
                                RAC_ChangeRadioState(Enumeration_AB.EnumerationABValue6);
                            }
                    ...
                    case Enumeration_AB.EnumerationABValue1:
                    {
                        ...
                        if(signal == Enumeration_AC.EnumerationACValue20
                            && !field_335.Value
                            && (!field_334.Value || !field_333.Value))
                        {
                            RAC_ChangeRadioState(Enumeration_AB.EnumerationABValue2);
                        }
                        break;
                    ...
                    case Enumeration_AB.EnumerationABValue3:
                    {
                                 ...
                                 || signal == Enumeration_AC.EnumerationACValue6)
                        {
                            ...
                            if((!field_326.Value || !field_325.Value)
                    ...
                    case Enumeration_AB.EnumerationABValue4:
                    {
                        ...
                        if(signal == Enumeration_AC.EnumerationACValue23
                            ...
                            && (!field_338.Value || !field_337.Value))
                        {
                            if(field_313.Value == Enumeration_AB.EnumerationABValue2
                                && !RAC_RxEnable)
                            {

                            }
                            else if(field_313.Value == Enumeration_AB.EnumerationABValue6
                                     && !RAC_TxEnable)
                            {
                                RAC_ChangeRadioState(Enumeration_AB.EnumerationABValue7);
                            }
                            else if(field_313.Value == Enumeration_AB.EnumerationABValue2
                                     && RAC_RxEnable)
                            {
                                RAC_ChangeRadioState(Enumeration_AB.EnumerationABValue2);
                            }
                ...
                if(previousState != RAC_currentRadioState)
                {
                    this.Log(LogBasicRadioActivityAsError ? LogLevel.Error : LogLevel.Info, "RSM Update at {0}, signal:{1} channel={2} ({3}), transition: {4}->{5} (TX={6} RX={7}) Lbt={8}",
                             GetTime(), signal, Channel, MODEM_GetCurrentPhy(), previousState, RAC_currentRadioState, RAC_internalTxState, RAC_internalRxState, PROTIMER_listenBeforeTalkState);
                    ...
                    for(uint i = 0; i < PROTIMER_NumberOfCaptureCompareChannels; ++i)
                    {
                        if(PROTIMER_captureCompareChannel[i].Field_56.Value
                           ...
                           && ((PROTIMER_captureCompareChannel[i].Field_50.Value == Enumeration_R.EnumerationRValue13
                                && ((uint)field_266.Value & currentStateBitmask) > 0)
                               || (PROTIMER_captureCompareChannel[i].Field_50.Value == Enumeration_R.EnumerationRValue14
                                   && ((uint)field_267.Value & currentStateBitmask) > 0)))
                        {
                            PROTIMER_captureCompareChannel[i].Capture(PROTIMER_BaseCounterValue, PROTIMER_WrapCounterValue);
                            PROTIMER_TriggerEvent(PROTIMER_GetCaptureCompareEventFromIndex(i));
                        }
                    ...
                    case Enumeration_AB.EnumerationABValue4:
                        ...
                        break;
                    case Enumeration_AB.EnumerationABValue5:
                        field_351.Value = true;
                        field_349.Value = true;
                        break;
                    case Enumeration_AB.EnumerationABValue6:
                        ...
                        break;
                    case Enumeration_AB.EnumerationABValue7:
                        field_355.Value = true;
                        field_353.Value = true;
                        break;
                    case Enumeration_AB.EnumerationABValue8:
        ...
        private void RAC_RxTimerLimitReached()
        {
            ...
            if(RAC_internalRxState == Enumeration_Z.EnumerationZValue1)
            {
                ...
                {
                    RAC_ClearOngoingRx();
                    this.Log(LogBasicRadioActivityAsError ? LogLevel.Error : LogLevel.Info, "Dropping (not in RXSEARCH): at {0} (channel {1}) ({2}Hz): {3}", GetTime(), Channel, SYNTH_Get2p4Frequency(), BitConverter.ToString(currentFrame));
                    return;
                }
                ...
                {
                    RAC_ClearOngoingRx();
                    this.Log(LogBasicRadioActivityAsError ? LogLevel.Error : LogLevel.Info, "Dropping (PRE/SYNC COLLISION): at {0} (channel {1}) ({2}Hz): {3}", GetTime(), Channel, SYNTH_Get2p4Frequency(), BitConverter.ToString(currentFrame));
                    return;
                }
                ...
                {
                    RAC_ClearOngoingRx();
                    this.Log(LogBasicRadioActivityAsError ? LogLevel.Error : LogLevel.Info, "Dropping (SYNC MISMATCH): at {0} (channel {1}) ({2}Hz): {3}", GetTime(), Channel, SYNTH_Get2p4Frequency(), BitConverter.ToString(currentFrame));
                    return;
                }
            ...
            {
                this.Log(LogBasicRadioActivityAsError ? LogLevel.Error : LogLevel.Info, "Received at {0} on channel {1} ({2}Hz) (RSSI={3}, collided={4}): {5}",
                         GetTime(), Channel, SYNTH_Get2p4Frequency(), AGC_FrameRssiIntegerPart, RAC_ongoingRxCollided, BitConverter.ToString(currentFrame));
        ...
        private bool TransmitFrame(byte[] frame)
        {
            ...
            this.Log(LogBasicRadioActivityAsError ? LogLevel.Error : LogLevel.Info, "Sending frame at {0} on channel {1} ({2}) ({3}Hz): {4}",
                     GetTime(), Channel, MODEM_GetCurrentPhy(), SYNTH_Get2p4Frequency(), BitConverter.ToString(frame));


            InterferenceQueue.Add(this, MODEM_GetCurrentPhy(), Channel, 0 , frame);

            FRC_SnifferTransmitFrame(frame);
        ...
        private ulong HfxoFrequency => hfxoFrequency;        
        ...
        private uint RAC_RxEnableMask => ((uint)field_363.Value
        ...
        private bool PROTIMER_Enabled
        {
            ...
            set
            {
                if(value)
                {
                    ...
                    proTimer.Limit = PROTIMER_ComputeTimerLimit();
                    proTimer.Enabled = true;
                    proTimer.Value = (!isRunning || field_298.Value) ? 0 : currentValue;
                }
                else
                {
                    proTimer.Enabled = false;
        ...
        private IFlagRegisterField field_284;
        ...
        private IFlagRegisterField field_262;
        private IValueRegisterField field_267;
        private IValueRegisterField field_266;
        private IValueRegisterField field_268;
        private IFlagRegisterField field_242;
        private IValueRegisterField field_241;
        private IValueRegisterField field_240;
        private IValueRegisterField field_251;
        private IValueRegisterField field_243;
        private IValueRegisterField field_246;
        private IValueRegisterField field_255;
        private IFlagRegisterField field_247;
        private IFlagRegisterField field_254;
        private IFlagRegisterField field_258;
        private IEnumRegisterField<PROTIMER_Event> field_292;
        private IEnumRegisterField<PROTIMER_Event> field_293;
        private IEnumRegisterField<PROTIMER_Event> field_272;
        private IEnumRegisterField<PROTIMER_Event> field_274;
        private IEnumRegisterField<PROTIMER_Event> field_275;
        private IEnumRegisterField<PROTIMER_Event> field_273;
        ...
        private IFlagRegisterField field_295;
        ...
        private IEnumRegisterField<Enumeration_Y> field_296;
        private IEnumRegisterField<Enumeration_P> field_237;
        private IEnumRegisterField<Enumeration_U> field_263;
        private IFlagRegisterField field_271;
        private IFlagRegisterField field_249;
        private IFlagRegisterField field_248;
        ...
        private IFlagRegisterField field_382;
        private IFlagRegisterField field_384;
        private IFlagRegisterField field_381;
        private IFlagRegisterField field_383;
        private IFlagRegisterField field_380;
        private IFlagRegisterField field_375;
        private IFlagRegisterField field_379;
        private IFlagRegisterField field_378;
        private IFlagRegisterField field_376;
        private Enumeration_AE SYNTH_state = Enumeration_AE.EnumerationAEValue0;
        private IValueRegisterField field_377;
        ...
        private IValueRegisterField field_308;
        ...
        private IFlagRegisterField field_305;
        private IFlagRegisterField field_364;
        private IEnumRegisterField<Enumeration_AB> field_307;
        private IEnumRegisterField<Enumeration_AB> field_313;
        private IFlagRegisterField field_360;
        private IFlagRegisterField field_361;
        private IFlagRegisterField field_362;
        private IFlagRegisterField field_306;
        private IValueRegisterField field_363;
        private IEnumRegisterField<Enumeration_AB> field_369;
        private IValueRegisterField field_309;
        ...
        private IFlagRegisterField field_358;
        private IFlagRegisterField field_320;
        private IFlagRegisterField field_341;
        private IFlagRegisterField field_355;
        private IFlagRegisterField field_347;
        private IFlagRegisterField field_351;
        ...
        private IEnumRegisterField<Enumeration_AD> field_366;
        private IEnumRegisterField<Enumeration_AD> field_367;

        private byte[] currentFrame;
        private uint currentFrameOffset;
        private int currentChannel = 0;

        private readonly IValueRegisterField[] field_373 = new IValueRegisterField[RFMAILBOX_MessageNumber];
        private readonly IFlagRegisterField[] field_371 = new IFlagRegisterField[RFMAILBOX_MessageNumber];
        private readonly IFlagRegisterField[] field_372 = new IFlagRegisterField[RFMAILBOX_MessageNumber];
        ...
        private readonly IValueRegisterField[] field_314 = new IValueRegisterField[RAC_NumberOfScratchRegisters];
        private readonly IValueRegisterField[] field_359 = new IValueRegisterField[RAC_NumberOfSequencerStorageRegisters];
        ...
        private readonly ulong hfxoFrequency;
        ...
        private const ulong MicrosecondFrequency = 1000000UL;
        private const ulong HalfMicrosecondFrequency = 2000000UL;
        ...
        private const uint PROTIMER_NumberOfCaptureCompareChannelPrsEvents = 5;
        ...
        private class PROTIMER_TimeoutCounter
        {
            ...
            public void Start()
            {
                if(Field_395.Value != Enumeration_W.EnumerationWValue0)
                {
                    Field_396.Value = true;
                    Field_374.Value = false;
                }
                else
                {
                    Field_374.Value = true;
                    Field_396.Value = false;
                    Field_52.Value = Field_54.Value;
                    Field_299.Value = Field_301.Value;
                }
            ...
            public void Update(Enumeration_W evt, uint evtCount = 1)
            {
                ...
                if((Field_374.Value || Field_396.Value) && evtCount > PROTIMER_MinimumTimeoutCounterDelay)
                {
                ...
                while(evtCount > 0)
                {
                    if(Field_374.Value && Field_394.Value == evt)
                    {
                        if(Field_299.Value == 0)
                        {
                            Field_299.Value = Field_301.Value;

                            if(Field_52.Value == 0)
                            {
                                Field_397.Value = true;
                                Field_391.Value = true;
                        ...
                        var match = (Field_52.Value == Field_53.Value && Field_299.Value == Field_300.Value);

                        if(match)
                        {
                            Field_229.Value |= match;
                            Field_387.Value |= match;
                    ...
                    if(Field_396.Value && Field_395.Value == evt)
                    {
                        Field_396.Value = false;
                        Field_374.Value = true;
                        Field_52.Value = Field_54.Value;
            ...
            public bool Interrupt => (Field_397.Value && Field_398.Value)
                                      || (Field_229.Value && Field_230.Value);

            public bool SeqInterrupt => (Field_391.Value && Field_392.Value)
                                         || (Field_387.Value && Field_388.Value);
            ...
            public IEnumRegisterField<Enumeration_W> Field_394;
            public IValueRegisterField Field_301;
            public IValueRegisterField Field_54;
            public IValueRegisterField Field_300;
            public IValueRegisterField Field_299;
            public IValueRegisterField Field_53;
            public IValueRegisterField Field_52;
            public IFlagRegisterField Field_388;
            public IFlagRegisterField Field_391;
            public IFlagRegisterField Field_392;
            public IEnumRegisterField<Enumeration_W> Field_395;
            public IFlagRegisterField Field_230;
            public IFlagRegisterField Field_229;
            public IFlagRegisterField Field_398;
            public IFlagRegisterField Field_397;
            public IFlagRegisterField Field_374;
            public IFlagRegisterField Field_396;
            public IFlagRegisterField Field_387;
        ...
        private class FRC_FrameDescriptor
        {
            ...
            public uint? Words => Field_399.Value == 0xFF ? null : (uint?)(Field_399.Value + 1);

            public uint BufferIndex => (uint)Field_45.Value;

            public IValueRegisterField Field_399;
            ...
            public IFlagRegisterField Field_393;
        ...
        private class PROTIMER_CaptureCompareChannel
        {
            ...
            public void Capture(uint baseVal, uint wrapVal)
            {
                if(Field_51.Value)
                {
                    ...
                    Field_389.Value = true;
                }

                Field_51.Value = true;
                Field_154.Value = true;
                Field_386.Value = true;

                Field_303.Value = 0;
                Field_44.Value = baseVal;
                Field_403.Value = wrapVal;
            ...
            public IValueRegisterField Field_400;
        ...
        private enum Enumeration_AE
        {
            EnumerationAEValue0   = 0,
            EnumerationAEValue1   = 1,
            EnumerationAEValue2   = 2,
        }
